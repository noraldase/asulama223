...
<body>
    <div class="container">
        <h1>PoopX402 | $POOP Mint</h1>

        <h2>Mint Token</h2>
        <p>Token Rate: 1 USDC = 10,000 $POOP</p>
        <p>Supply: 1,000,000,000 $POOP (Total)</p>
        ...
        <h2>Social</h2>
        <p>Follow <a href="https://x.com/Poop_x402" target="_blank" rel="noopener noreferrer">@Poop_X402</a> on X</p>
    ...
    <script>
        ...
        const RELAYER_URL = "https://api.poopx402.site/mint"; // Ganti jika relayer endpoint berbeda
        const CONTRACT_SALE_MANAGER_ADDRESS = "0x0A96FEcF9313fe65b226295Bb031B71015AF9390"; // Tetap sama seperti referensi
        
        const USDC_CONTRACT_ADDRESS = "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913"; // USDC Base Mainnet
        const CHAIN_ID = 8453; // Base Mainnet
        
        const BASE_RATE = 10000; // 1 USDC = 5000 $POOP
    ...
    "function paymentWallet() view returns (address)", 
];
        ...
        async function connectWallet() {
            ...
            try {
                ...
                ownerWalletAddress = await saleContract.paymentWallet();
        ...
        async function mintToken(usdcAmount) {
            ...
            try {
                ...
                statusMessage.textContent = `2. Signature obtained for ${usdcAmount} USDC.`;
                ...
                const signatureBody = {
                    ...
                    r: signatureParts.r,
                    s: signatureParts.s,
                    usdcAmount: usdcAmount // Tambahkan amount agar relayer tahu berapa $POOP yang harus dikirim
                };
                ...
                if (result.success && result.txHash) {
                    statusMessage.innerHTML = `✅ **Mint Success!** ${tokenAmount.toLocaleString()} $POOP sent! <br>Tx: <a href="https://basescan.org/tx/${result.txHash}" target="_blank">${result.txHash.substring(0,10)}...</a>`;
                } else {
